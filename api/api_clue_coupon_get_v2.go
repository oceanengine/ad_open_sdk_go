...
func (r *ApiOpenApi2ClueCouponGetGetRequest) ActivityTypes(activityTypes []string) *ApiOpenApi2ClueCouponGetGetRequest {
...
func (r *ApiOpenApi2ClueCouponGetGetRequest) IsDel(isDel interface{}) *ApiOpenApi2ClueCouponGetGetRequest {
	r.isDel = &isDel
	return r
}

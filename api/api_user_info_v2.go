...
type UserInfoV2ApiService service

type ApiOpenApi2UserInfoGetRequest struct {
	ctx        context.Context
...
func (r *ApiOpenApi2UserInfoGetRequest) AccessToken(accessToken string) *ApiOpenApi2UserInfoGetRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2UserInfoGetRequest) WithLog(enable bool) *ApiOpenApi2UserInfoGetRequest {
	if enable {
...
*/
func (a *UserInfoV2ApiService) Get(ctx context.Context) *ApiOpenApi2UserInfoGetRequest {
	return &ApiOpenApi2UserInfoGetRequest{
		ApiService: a,
		ctx:        ctx,
	}

...
func (r *ApiOpenApi2DmpCustomAudienceReadGetRequest) Execute() (*models.DmpCustomAudienceReadV2Response, *http.Response, error) {
...
func (a *DmpCustomAudienceReadV2ApiService) getExecute(r *ApiOpenApi2DmpCustomAudienceReadGetRequest) (*models.DmpCustomAudienceReadV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.DmpCustomAudienceReadV2Response
	)

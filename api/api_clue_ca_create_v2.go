...
type ClueCaCreateV2ApiService service
...
func (r *ApiOpenApi2ClueCaCreatePostRequest) AccessToken(accessToken string) *ApiOpenApi2ClueCaCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2ClueCaCreatePostRequest) WithLog(enable bool) *ApiOpenApi2ClueCaCreatePostRequest {
	if enable {
...
/*
OpenApi2ClueCaCreatePost Method for OpenApi2ClueCaCreatePost

创建获客助手链接

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApi2ClueCaCreatePostRequest
*/
func (a *ClueCaCreateV2ApiService) Post(ctx context.Context) *ApiOpenApi2ClueCaCreatePostRequest {
	return &ApiOpenApi2ClueCaCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ClueCaCreateV2ApiService) postExecute(r *ApiOpenApi2ClueCaCreatePostRequest) (*ClueCaCreateV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.clueCaCreateV2Request

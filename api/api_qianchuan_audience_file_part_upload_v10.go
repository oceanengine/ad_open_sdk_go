...
func (r *ApiOpenApiV10QianchuanAudienceFilePartUploadPostRequest) File(file *os.File) *ApiOpenApiV10QianchuanAudienceFilePartUploadPostRequest {
	r.file = file
	return r
}
...
func (a *QianchuanAudienceFilePartUploadV10ApiService) postExecute(r *ApiOpenApiV10QianchuanAudienceFilePartUploadPostRequest) (*QianchuanAudienceFilePartUploadV10Response, *http.Response, error) {
	...
	if fileLocalVarFile != nil {
		...
		formFiles[LocalVarFormFileName] = FormFile{FileBytes: fileLocalVarFileBytes, FileName: fileLocalVarFileName}
	}
	if r.fileKey != nil {

...
func (r *ApiOpenApi2StarVasGetBoostItemGroupDetailGetRequest) Execute() (*models.StarVasGetBoostItemGroupDetailV2Response, *http.Response, error) {
...
func (a *StarVasGetBoostItemGroupDetailV2ApiService) getExecute(r *ApiOpenApi2StarVasGetBoostItemGroupDetailGetRequest) (*models.StarVasGetBoostItemGroupDetailV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarVasGetBoostItemGroupDetailV2Response
	)

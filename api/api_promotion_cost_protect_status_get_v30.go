...
func (r *ApiOpenApiV30PromotionCostProtectStatusGetGetRequest) Execute() (*models.PromotionCostProtectStatusGetV30Response, *http.Response, error) {
...
func (a *PromotionCostProtectStatusGetV30ApiService) getExecute(r *ApiOpenApiV30PromotionCostProtectStatusGetGetRequest) (*models.PromotionCostProtectStatusGetV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.PromotionCostProtectStatusGetV30Response
	)

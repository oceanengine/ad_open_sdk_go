...
func (r *ApiOpenApi2DpaMetaGetGetRequest) Execute() (*models.DpaMetaGetV2Response, *http.Response, error) {
...
func (a *DpaMetaGetV2ApiService) getExecute(r *ApiOpenApi2DpaMetaGetGetRequest) (*models.DpaMetaGetV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.DpaMetaGetV2Response
	)

...
type EventManagerAuthAddPublicKeyV2ApiService service
...
func (r *ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest) AccessToken(accessToken string) *ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest) WithLog(enable bool) *ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest {
	if enable {
...
/*
OpenApi2EventManagerAuthAddPublicKeyPost Method for OpenApi2EventManagerAuthAddPublicKeyPost

# API Description

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest
*/
func (a *EventManagerAuthAddPublicKeyV2ApiService) Post(ctx context.Context) *ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest {
	return &ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EventManagerAuthAddPublicKeyV2ApiService) postExecute(r *ApiOpenApi2EventManagerAuthAddPublicKeyPostRequest) (*EventManagerAuthAddPublicKeyV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.eventManagerAuthAddPublicKeyV2Request

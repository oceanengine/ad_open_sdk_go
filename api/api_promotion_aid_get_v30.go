...
func (r *ApiOpenApiV30PromotionAidGetGetRequest) Execute() (*models.PromotionAidGetV30Response, *http.Response, error) {
...
func (a *PromotionAidGetV30ApiService) getExecute(r *ApiOpenApiV30PromotionAidGetGetRequest) (*models.PromotionAidGetV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.PromotionAidGetV30Response
	)

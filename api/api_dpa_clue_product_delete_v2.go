...
type DpaClueProductDeleteV2ApiService service
...
func (r *ApiOpenApi2DpaClueProductDeletePostRequest) AccessToken(accessToken string) *ApiOpenApi2DpaClueProductDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2DpaClueProductDeletePostRequest) WithLog(enable bool) *ApiOpenApi2DpaClueProductDeletePostRequest {
	if enable {
...
*/
func (a *DpaClueProductDeleteV2ApiService) Post(ctx context.Context) *ApiOpenApi2DpaClueProductDeletePostRequest {
	return &ApiOpenApi2DpaClueProductDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DpaClueProductDeleteV2ApiService) postExecute(r *ApiOpenApi2DpaClueProductDeletePostRequest) (*DpaClueProductDeleteV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.dpaClueProductDeleteV2Request

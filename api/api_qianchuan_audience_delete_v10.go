...
type QianchuanAudienceDeleteV10ApiService service
...
func (r *ApiOpenApiV10QianchuanAudienceDeletePostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanAudienceDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanAudienceDeletePostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanAudienceDeletePostRequest {
	if enable {
...
*/
func (a *QianchuanAudienceDeleteV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanAudienceDeletePostRequest {
	return &ApiOpenApiV10QianchuanAudienceDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanAudienceDeleteV10ApiService) postExecute(r *ApiOpenApiV10QianchuanAudienceDeletePostRequest) (*QianchuanAudienceDeleteV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanAudienceDeleteV10Request

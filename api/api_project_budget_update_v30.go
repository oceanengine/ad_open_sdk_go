...
type ApiOpenApiV30ProjectBudgetUpdatePostRequest struct {
	...
	projectBudgetUpdateV30Request *models.ProjectBudgetUpdateV30Request
}

func (r *ApiOpenApiV30ProjectBudgetUpdatePostRequest) ProjectBudgetUpdateV30Request(projectBudgetUpdateV30Request models.ProjectBudgetUpdateV30Request) *ApiOpenApiV30ProjectBudgetUpdatePostRequest {
	r.projectBudgetUpdateV30Request = &projectBudgetUpdateV30Request
	return r
}

func (r *ApiOpenApiV30ProjectBudgetUpdatePostRequest) Execute() (*models.ProjectBudgetUpdateV30Response, *http.Response, error) {
...
func (a *ProjectBudgetUpdateV30ApiService) postExecute(r *ApiOpenApiV30ProjectBudgetUpdatePostRequest) (*models.ProjectBudgetUpdateV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.ProjectBudgetUpdateV30Response
	)

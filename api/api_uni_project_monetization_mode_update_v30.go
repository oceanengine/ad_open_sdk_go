...
type UniProjectMonetizationModeUpdateV30ApiService service
...
func (r *ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest {
	if enable {
...
/*
OpenApiV30UniProjectMonetizationModeUpdatePost Method for OpenApiV30UniProjectMonetizationModeUpdatePost

批量更新项目变现模式

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest
*/
func (a *UniProjectMonetizationModeUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest {
	return &ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *UniProjectMonetizationModeUpdateV30ApiService) postExecute(r *ApiOpenApiV30UniProjectMonetizationModeUpdatePostRequest) (*models.UniProjectMonetizationModeUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.uniProjectMonetizationModeUpdateV30Request

...
type ToolsEbpAppUpdateV30ApiService service
...
func (r *ApiOpenApiV30ToolsEbpAppUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsEbpAppUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsEbpAppUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsEbpAppUpdatePostRequest {
	if enable {
...
/*
OpenApiV30ToolsEbpAppUpdatePost Method for OpenApiV30ToolsEbpAppUpdatePost

更新安卓应用母包

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30ToolsEbpAppUpdatePostRequest
*/
func (a *ToolsEbpAppUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsEbpAppUpdatePostRequest {
	return &ApiOpenApiV30ToolsEbpAppUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsEbpAppUpdateV30ApiService) postExecute(r *ApiOpenApiV30ToolsEbpAppUpdatePostRequest) (*ToolsEbpAppUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsEbpAppUpdateV30Request

...
type ToolsClueWebrtcCreateV2V30ApiService service
...
func (r *ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest {
	if enable {
...
*/
func (a *ToolsClueWebrtcCreateV2V30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest {
	return &ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsClueWebrtcCreateV2V30ApiService) postExecute(r *ApiOpenApiV30ToolsClueWebrtcCreateV2PostRequest) (*ToolsClueWebrtcCreateV2V30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsClueWebrtcCreateV2V30Request

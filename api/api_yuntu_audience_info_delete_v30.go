...
type YuntuAudienceInfoDeleteV30ApiService service
...
func (r *ApiOpenApiV30YuntuAudienceInfoDeletePostRequest) AccessToken(accessToken string) *ApiOpenApiV30YuntuAudienceInfoDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30YuntuAudienceInfoDeletePostRequest) WithLog(enable bool) *ApiOpenApiV30YuntuAudienceInfoDeletePostRequest {
	if enable {
...
*/
func (a *YuntuAudienceInfoDeleteV30ApiService) Post(ctx context.Context) *ApiOpenApiV30YuntuAudienceInfoDeletePostRequest {
	return &ApiOpenApiV30YuntuAudienceInfoDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *YuntuAudienceInfoDeleteV30ApiService) postExecute(r *ApiOpenApiV30YuntuAudienceInfoDeletePostRequest) (*YuntuAudienceInfoDeleteV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.yuntuAudienceInfoDeleteV30Request

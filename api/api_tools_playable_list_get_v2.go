...
func (r *ApiOpenApi2ToolsPlayableListGetGetRequest) PlayableSource(playableSource interface{}) *ApiOpenApi2ToolsPlayableListGetGetRequest {
...
func (r *ApiOpenApi2ToolsPlayableListGetGetRequest) Status(status interface{}) *ApiOpenApi2ToolsPlayableListGetGetRequest {
	r.status = &status
	return r
}

...
// 图片文件
func (r *ApiOpenApiV30BrandUploadImagePostRequest) ImageFile(imageFile *models.FormFileInfo) *ApiOpenApiV30BrandUploadImagePostRequest {
	r.imageFile = imageFile
	return r
}

func (r *ApiOpenApiV30BrandUploadImagePostRequest) Execute() (*models.BrandUploadImageV30Response, *http.Response, error) {
...
func (a *BrandUploadImageV30ApiService) postExecute(r *ApiOpenApiV30BrandUploadImagePostRequest) (*models.BrandUploadImageV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.BrandUploadImageV30Response
	)

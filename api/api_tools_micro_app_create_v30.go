...
type ToolsMicroAppCreateV30ApiService service
...
func (r *ApiOpenApiV30ToolsMicroAppCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsMicroAppCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsMicroAppCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsMicroAppCreatePostRequest {
	if enable {
...
*/
func (a *ToolsMicroAppCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsMicroAppCreatePostRequest {
	return &ApiOpenApiV30ToolsMicroAppCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsMicroAppCreateV30ApiService) postExecute(r *ApiOpenApiV30ToolsMicroAppCreatePostRequest) (*ToolsMicroAppCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsMicroAppCreateV30Request

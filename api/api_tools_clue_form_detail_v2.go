...
func (r *ApiOpenApi2ToolsClueFormDetailGetRequest) Execute() (*models.ToolsClueFormDetailV2Response, *http.Response, error) {
...
func (a *ToolsClueFormDetailV2ApiService) getExecute(r *ApiOpenApi2ToolsClueFormDetailGetRequest) (*models.ToolsClueFormDetailV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.ToolsClueFormDetailV2Response
	)

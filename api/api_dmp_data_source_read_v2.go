...
func (r *ApiOpenApi2DmpDataSourceReadGetRequest) Execute() (*models.DmpDataSourceReadV2Response, *http.Response, error) {
...
func (a *DmpDataSourceReadV2ApiService) getExecute(r *ApiOpenApi2DmpDataSourceReadGetRequest) (*models.DmpDataSourceReadV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.DmpDataSourceReadV2Response
	)

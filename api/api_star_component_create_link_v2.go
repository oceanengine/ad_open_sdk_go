...
type StarComponentCreateLinkV2ApiService service
...
func (r *ApiOpenApi2StarComponentCreateLinkPostRequest) AccessToken(accessToken string) *ApiOpenApi2StarComponentCreateLinkPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2StarComponentCreateLinkPostRequest) WithLog(enable bool) *ApiOpenApi2StarComponentCreateLinkPostRequest {
	if enable {
...
*/
func (a *StarComponentCreateLinkV2ApiService) Post(ctx context.Context) *ApiOpenApi2StarComponentCreateLinkPostRequest {
	return &ApiOpenApi2StarComponentCreateLinkPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *StarComponentCreateLinkV2ApiService) postExecute(r *ApiOpenApi2StarComponentCreateLinkPostRequest) (*StarComponentCreateLinkV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.starComponentCreateLinkV2Request

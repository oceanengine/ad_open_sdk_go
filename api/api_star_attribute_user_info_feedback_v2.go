...
type StarAttributeUserInfoFeedbackV2ApiService service
...
func (r *ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest) AccessToken(accessToken string) *ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest) WithLog(enable bool) *ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest {
	if enable {
...
*/
func (a *StarAttributeUserInfoFeedbackV2ApiService) Post(ctx context.Context) *ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest {
	return &ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *StarAttributeUserInfoFeedbackV2ApiService) postExecute(r *ApiOpenApi2StarAttributeUserInfoFeedbackPostRequest) (*StarAttributeUserInfoFeedbackV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.starAttributeUserInfoFeedbackV2Request

...
type LocalImAutoSettingUpdateV30ApiService service
...
func (r *ApiOpenApiV30LocalImAutoSettingUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30LocalImAutoSettingUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30LocalImAutoSettingUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30LocalImAutoSettingUpdatePostRequest {
	if enable {
...
/*
OpenApiV30LocalImAutoSettingUpdatePost Method for OpenApiV30LocalImAutoSettingUpdatePost

更新线索私信功能开关

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30LocalImAutoSettingUpdatePostRequest
*/
func (a *LocalImAutoSettingUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30LocalImAutoSettingUpdatePostRequest {
	return &ApiOpenApiV30LocalImAutoSettingUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LocalImAutoSettingUpdateV30ApiService) postExecute(r *ApiOpenApiV30LocalImAutoSettingUpdatePostRequest) (*LocalImAutoSettingUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.localImAutoSettingUpdateV30Request

...
func (r *ApiOpenApi2ToolsTaskRaiseDataGetGetRequest) Execute() (*models.ToolsTaskRaiseDataGetV2Response, *http.Response, error) {
...
func (a *ToolsTaskRaiseDataGetV2ApiService) getExecute(r *ApiOpenApi2ToolsTaskRaiseDataGetGetRequest) (*models.ToolsTaskRaiseDataGetV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.ToolsTaskRaiseDataGetV2Response
	)

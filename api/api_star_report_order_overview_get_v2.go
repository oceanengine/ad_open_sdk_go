...
func (r *ApiOpenApi2StarReportOrderOverviewGetGetRequest) Execute() (*models.StarReportOrderOverviewGetV2Response, *http.Response, error) {
...
func (a *StarReportOrderOverviewGetV2ApiService) getExecute(r *ApiOpenApi2StarReportOrderOverviewGetGetRequest) (*models.StarReportOrderOverviewGetV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarReportOrderOverviewGetV2Response
	)

...
func (r *ApiOpenApi2StarMcnProviderGetTaskAuthorListGetRequest) Execute() (*models.StarMcnProviderGetTaskAuthorListV2Response, *http.Response, error) {
...
func (a *StarMcnProviderGetTaskAuthorListV2ApiService) getExecute(r *ApiOpenApi2StarMcnProviderGetTaskAuthorListGetRequest) (*models.StarMcnProviderGetTaskAuthorListV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarMcnProviderGetTaskAuthorListV2Response
	)

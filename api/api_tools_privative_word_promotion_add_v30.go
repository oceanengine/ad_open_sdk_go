...
type ApiOpenApiV30ToolsPrivativeWordPromotionAddPostRequest struct {
	...
	toolsPrivativeWordPromotionAddV30Request *models.ToolsPrivativeWordPromotionAddV30Request
}

func (r *ApiOpenApiV30ToolsPrivativeWordPromotionAddPostRequest) ToolsPrivativeWordPromotionAddV30Request(toolsPrivativeWordPromotionAddV30Request models.ToolsPrivativeWordPromotionAddV30Request) *ApiOpenApiV30ToolsPrivativeWordPromotionAddPostRequest {
	r.toolsPrivativeWordPromotionAddV30Request = &toolsPrivativeWordPromotionAddV30Request
	return r
}

func (r *ApiOpenApiV30ToolsPrivativeWordPromotionAddPostRequest) Execute() (*models.ToolsPrivativeWordPromotionAddV30Response, *http.Response, error) {
...
func (a *ToolsPrivativeWordPromotionAddV30ApiService) postExecute(r *ApiOpenApiV30ToolsPrivativeWordPromotionAddPostRequest) (*models.ToolsPrivativeWordPromotionAddV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.ToolsPrivativeWordPromotionAddV30Response
	)

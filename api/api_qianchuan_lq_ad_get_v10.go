...
type ApiOpenApiV10QianchuanLqAdGetGetRequest struct {
	...
	advertiserId *int64
	filtering    *models.QianchuanLqAdGetV10Filtering
}
...
// 过滤条件
func (r *ApiOpenApiV10QianchuanLqAdGetGetRequest) Filtering(filtering models.QianchuanLqAdGetV10Filtering) *ApiOpenApiV10QianchuanLqAdGetGetRequest {
	r.filtering = &filtering
	return r
}

func (r *ApiOpenApiV10QianchuanLqAdGetGetRequest) Execute() (*models.QianchuanLqAdGetV10Response, *http.Response, error) {
...
func (a *QianchuanLqAdGetV10ApiService) getExecute(r *ApiOpenApiV10QianchuanLqAdGetGetRequest) (*models.QianchuanLqAdGetV10Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.QianchuanLqAdGetV10Response
	)

...
type LocalProjectCreateV30ApiService service
...
func (r *ApiOpenApiV30LocalProjectCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30LocalProjectCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30LocalProjectCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30LocalProjectCreatePostRequest {
	if enable {
...
/*
OpenApiV30LocalProjectCreatePost Method for OpenApiV30LocalProjectCreatePost

创建项目

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30LocalProjectCreatePostRequest
*/
func (a *LocalProjectCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30LocalProjectCreatePostRequest {
	return &ApiOpenApiV30LocalProjectCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LocalProjectCreateV30ApiService) postExecute(r *ApiOpenApiV30LocalProjectCreatePostRequest) (*LocalProjectCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.localProjectCreateV30Request

...
type QianchuanUniPromotionAdProductDeleteV10ApiService service
...
func (r *ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest {
	if enable {
...
*/
func (a *QianchuanUniPromotionAdProductDeleteV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest {
	return &ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanUniPromotionAdProductDeleteV10ApiService) postExecute(r *ApiOpenApiV10QianchuanUniPromotionAdProductDeletePostRequest) (*QianchuanUniPromotionAdProductDeleteV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanUniPromotionAdProductDeleteV10Request

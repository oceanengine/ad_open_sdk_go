...
func (r *ApiOpenApi2StarUserGetAwemeAuthorIdGetRequest) Execute() (*models.StarUserGetAwemeAuthorIdV2Response, *http.Response, error) {
...
func (a *StarUserGetAwemeAuthorIdV2ApiService) getExecute(r *ApiOpenApi2StarUserGetAwemeAuthorIdGetRequest) (*models.StarUserGetAwemeAuthorIdV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarUserGetAwemeAuthorIdV2Response
	)

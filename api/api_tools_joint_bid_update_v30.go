...
type ToolsJointBidUpdateV30ApiService service
...
func (r *ApiOpenApiV30ToolsJointBidUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsJointBidUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsJointBidUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsJointBidUpdatePostRequest {
	if enable {
...
/*
OpenApiV30ToolsJointBidUpdatePost Method for OpenApiV30ToolsJointBidUpdatePost

更新联合出价范围及RTA_ID

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30ToolsJointBidUpdatePostRequest
*/
func (a *ToolsJointBidUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsJointBidUpdatePostRequest {
	return &ApiOpenApiV30ToolsJointBidUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsJointBidUpdateV30ApiService) postExecute(r *ApiOpenApiV30ToolsJointBidUpdatePostRequest) (*ToolsJointBidUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsJointBidUpdateV30Request

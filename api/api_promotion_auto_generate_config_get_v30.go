...
func (r *ApiOpenApiV30PromotionAutoGenerateConfigGetGetRequest) Execute() (*models.PromotionAutoGenerateConfigGetV30Response, *http.Response, error) {
...
func (a *PromotionAutoGenerateConfigGetV30ApiService) getExecute(r *ApiOpenApiV30PromotionAutoGenerateConfigGetGetRequest) (*models.PromotionAutoGenerateConfigGetV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.PromotionAutoGenerateConfigGetV30Response
	)

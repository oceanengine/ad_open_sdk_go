...
type DiagnosisTaskAgentCreateV2ApiService service
...
func (r *ApiOpenApi2DiagnosisTaskAgentCreatePostRequest) AccessToken(accessToken string) *ApiOpenApi2DiagnosisTaskAgentCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2DiagnosisTaskAgentCreatePostRequest) WithLog(enable bool) *ApiOpenApi2DiagnosisTaskAgentCreatePostRequest {
	if enable {
...
*/
func (a *DiagnosisTaskAgentCreateV2ApiService) Post(ctx context.Context) *ApiOpenApi2DiagnosisTaskAgentCreatePostRequest {
	return &ApiOpenApi2DiagnosisTaskAgentCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DiagnosisTaskAgentCreateV2ApiService) postExecute(r *ApiOpenApi2DiagnosisTaskAgentCreatePostRequest) (*DiagnosisTaskAgentCreateV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.diagnosisTaskAgentCreateV2Request

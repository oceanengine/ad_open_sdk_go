...
type AdvConvertOleConvertV2ApiService service
...
func (r *ApiOpenApi2AdvConvertOleConvertPostRequest) AccessToken(accessToken string) *ApiOpenApi2AdvConvertOleConvertPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2AdvConvertOleConvertPostRequest) WithLog(enable bool) *ApiOpenApi2AdvConvertOleConvertPostRequest {
	if enable {
...
*/
func (a *AdvConvertOleConvertV2ApiService) Post(ctx context.Context) *ApiOpenApi2AdvConvertOleConvertPostRequest {
	return &ApiOpenApi2AdvConvertOleConvertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdvConvertOleConvertV2ApiService) postExecute(r *ApiOpenApi2AdvConvertOleConvertPostRequest) (*AdvConvertOleConvertV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.advConvertOleConvertV2Request

...
func (r *ApiOpenApi2StarOrderGetCancelAmountGetRequest) Execute() (*models.StarOrderGetCancelAmountV2Response, *http.Response, error) {
...
func (a *StarOrderGetCancelAmountV2ApiService) getExecute(r *ApiOpenApi2StarOrderGetCancelAmountGetRequest) (*models.StarOrderGetCancelAmountV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarOrderGetCancelAmountV2Response
	)

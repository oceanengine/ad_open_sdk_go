...
type OcProjectToolsKeywordCreateV30ApiService service
...
func (r *ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest {
	if enable {
...
/*
OpenApiV30OcProjectToolsKeywordCreatePost Method for OpenApiV30OcProjectToolsKeywordCreatePost

创建关键词调控任务

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest
*/
func (a *OcProjectToolsKeywordCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest {
	return &ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *OcProjectToolsKeywordCreateV30ApiService) postExecute(r *ApiOpenApiV30OcProjectToolsKeywordCreatePostRequest) (*OcProjectToolsKeywordCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.ocProjectToolsKeywordCreateV30Request

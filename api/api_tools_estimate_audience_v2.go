...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Geolocation(geolocation []*AdGetV2ResponseDataAudienceGeolocationInner) *ApiOpenApi2ToolsEstimateAudienceGetRequest {

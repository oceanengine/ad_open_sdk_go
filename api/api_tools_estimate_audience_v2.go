...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Ac(ac []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.ac = &ac
	return r
}
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) ActivateType(activateType []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Age(age []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.age = &age
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) AndroidOsv(androidOsv interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.androidOsv = &androidOsv
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) AppBehaviorTarget(appBehaviorTarget interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) ArticleCategory(articleCategory []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) AutoExtendTargets(autoExtendTargets []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Carrier(carrier []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.carrier = &carrier
	return r
}
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) DeviceBrand(deviceBrand []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.deviceBrand = &deviceBrand
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) DeviceType(deviceType []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.deviceType = &deviceType
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) District(district interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.district = &district
	return r
}
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Gender(gender interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.gender = &gender
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Geolocation(geolocation []*AudiencePackageUpdateV2RequestGeolocationInner) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) InterestActionMode(interestActionMode interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) IosOsv(iosOsv interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.iosOsv = &iosOsv
	return r
}
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) LocationType(locationType interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.locationType = &locationType
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) Platform(platform []string) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.platform = &platform
	return r
}
...
func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) RetargetingType(retargetingType interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {
	r.retargetingType = &retargetingType
	return r
}

func (r *ApiOpenApi2ToolsEstimateAudienceGetRequest) SuperiorPopularityType(superiorPopularityType interface{}) *ApiOpenApi2ToolsEstimateAudienceGetRequest {

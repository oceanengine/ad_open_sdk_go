...
func (r *ApiOpenApi2StarStarAdUniteTaskDetailGetRequest) Execute() (*models.StarStarAdUniteTaskDetailV2Response, *http.Response, error) {
...
func (a *StarStarAdUniteTaskDetailV2ApiService) getExecute(r *ApiOpenApi2StarStarAdUniteTaskDetailGetRequest) (*models.StarStarAdUniteTaskDetailV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarStarAdUniteTaskDetailV2Response
	)

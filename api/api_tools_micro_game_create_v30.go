...
type ApiOpenApiV30ToolsMicroGameCreatePostRequest struct {
	...
	toolsMicroGameCreateV30Request *models.ToolsMicroGameCreateV30Request
}

func (r *ApiOpenApiV30ToolsMicroGameCreatePostRequest) ToolsMicroGameCreateV30Request(toolsMicroGameCreateV30Request models.ToolsMicroGameCreateV30Request) *ApiOpenApiV30ToolsMicroGameCreatePostRequest {
	r.toolsMicroGameCreateV30Request = &toolsMicroGameCreateV30Request
	return r
}

func (r *ApiOpenApiV30ToolsMicroGameCreatePostRequest) Execute() (*models.ToolsMicroGameCreateV30Response, *http.Response, error) {
...
func (a *ToolsMicroGameCreateV30ApiService) postExecute(r *ApiOpenApiV30ToolsMicroGameCreatePostRequest) (*models.ToolsMicroGameCreateV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.ToolsMicroGameCreateV30Response
	)

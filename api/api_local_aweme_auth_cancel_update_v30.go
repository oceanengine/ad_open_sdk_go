...
type LocalAwemeAuthCancelUpdateV30ApiService service
...
func (r *ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest {
	if enable {
...
/*
OpenApiV30LocalAwemeAuthCancelUpdatePost Method for OpenApiV30LocalAwemeAuthCancelUpdatePost

解除抖音号授权

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest
*/
func (a *LocalAwemeAuthCancelUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest {
	return &ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LocalAwemeAuthCancelUpdateV30ApiService) postExecute(r *ApiOpenApiV30LocalAwemeAuthCancelUpdatePostRequest) (*LocalAwemeAuthCancelUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.localAwemeAuthCancelUpdateV30Request

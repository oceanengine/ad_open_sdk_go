...
type AssetsCreativeComponentCreateV2ApiService service
...
func (r *ApiOpenApi2AssetsCreativeComponentCreatePostRequest) AccessToken(accessToken string) *ApiOpenApi2AssetsCreativeComponentCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2AssetsCreativeComponentCreatePostRequest) WithLog(enable bool) *ApiOpenApi2AssetsCreativeComponentCreatePostRequest {
	if enable {
...
/*
OpenApi2AssetsCreativeComponentCreatePost Method for OpenApi2AssetsCreativeComponentCreatePost

API Description

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApi2AssetsCreativeComponentCreatePostRequest
*/
func (a *AssetsCreativeComponentCreateV2ApiService) Post(ctx context.Context) *ApiOpenApi2AssetsCreativeComponentCreatePostRequest {
	return &ApiOpenApi2AssetsCreativeComponentCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AssetsCreativeComponentCreateV2ApiService) postExecute(r *ApiOpenApi2AssetsCreativeComponentCreatePostRequest) (*AssetsCreativeComponentCreateV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.assetsCreativeComponentCreateV2Request

...
type QianchuanAdScheduleFixedRangeUpdateV10ApiService service
...
func (r *ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest {
	if enable {
...
*/
func (a *QianchuanAdScheduleFixedRangeUpdateV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest {
	return &ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanAdScheduleFixedRangeUpdateV10ApiService) postExecute(r *ApiOpenApiV10QianchuanAdScheduleFixedRangeUpdatePostRequest) (*QianchuanAdScheduleFixedRangeUpdateV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanAdScheduleFixedRangeUpdateV10Request

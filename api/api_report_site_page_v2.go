...
type ApiOpenApi2ReportSitePageGetRequest struct {
	...
	advertiserId  *int64
	inventoryType *interface{}
	siteId        *string
	timeDuration  *interface{}
}
...
func (r *ApiOpenApi2ReportSitePageGetRequest) InventoryType(inventoryType interface{}) *ApiOpenApi2ReportSitePageGetRequest {
...
func (r *ApiOpenApi2ReportSitePageGetRequest) TimeDuration(timeDuration interface{}) *ApiOpenApi2ReportSitePageGetRequest {

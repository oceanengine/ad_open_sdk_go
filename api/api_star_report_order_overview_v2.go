...
func (r *ApiOpenApi2StarReportOrderOverviewGetRequest) Execute() (*models.StarReportOrderOverviewV2Response, *http.Response, error) {
...
func (a *StarReportOrderOverviewV2ApiService) getExecute(r *ApiOpenApi2StarReportOrderOverviewGetRequest) (*models.StarReportOrderOverviewV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarReportOrderOverviewV2Response
	)

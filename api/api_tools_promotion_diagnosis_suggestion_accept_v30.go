...
type ToolsPromotionDiagnosisSuggestionAcceptV30ApiService service
...
func (r *ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest {
	if enable {
...
*/
func (a *ToolsPromotionDiagnosisSuggestionAcceptV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest {
	return &ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsPromotionDiagnosisSuggestionAcceptV30ApiService) postExecute(r *ApiOpenApiV30ToolsPromotionDiagnosisSuggestionAcceptPostRequest) (*ToolsPromotionDiagnosisSuggestionAcceptV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsPromotionDiagnosisSuggestionAcceptV30Request

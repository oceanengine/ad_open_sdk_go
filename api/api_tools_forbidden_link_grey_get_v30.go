...
func (r *ApiOpenApiV30ToolsForbiddenLinkGreyGetGetRequest) Execute() (*models.ToolsForbiddenLinkGreyGetV30Response, *http.Response, error) {
...
func (a *ToolsForbiddenLinkGreyGetV30ApiService) getExecute(r *ApiOpenApiV30ToolsForbiddenLinkGreyGetGetRequest) (*models.ToolsForbiddenLinkGreyGetV30Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.ToolsForbiddenLinkGreyGetV30Response
	)

...
type YuntuAudienceLabelCreateV30ApiService service
...
func (r *ApiOpenApiV30YuntuAudienceLabelCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30YuntuAudienceLabelCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30YuntuAudienceLabelCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30YuntuAudienceLabelCreatePostRequest {
	if enable {
...
*/
func (a *YuntuAudienceLabelCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30YuntuAudienceLabelCreatePostRequest {
	return &ApiOpenApiV30YuntuAudienceLabelCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *YuntuAudienceLabelCreateV30ApiService) postExecute(r *ApiOpenApiV30YuntuAudienceLabelCreatePostRequest) (*YuntuAudienceLabelCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.yuntuAudienceLabelCreateV30Request

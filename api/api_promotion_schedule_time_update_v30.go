...
type PromotionScheduleTimeUpdateV30ApiService service
...
func (r *ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest {
	if enable {
...
*/
func (a *PromotionScheduleTimeUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest {
	return &ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *PromotionScheduleTimeUpdateV30ApiService) postExecute(r *ApiOpenApiV30PromotionScheduleTimeUpdatePostRequest) (*PromotionScheduleTimeUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.promotionScheduleTimeUpdateV30Request

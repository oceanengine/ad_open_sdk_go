...
type StarComponentCreateCommonComponentV2ApiService service
...
func (r *ApiOpenApi2StarComponentCreateCommonComponentPostRequest) AccessToken(accessToken string) *ApiOpenApi2StarComponentCreateCommonComponentPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2StarComponentCreateCommonComponentPostRequest) WithLog(enable bool) *ApiOpenApi2StarComponentCreateCommonComponentPostRequest {
	if enable {
...
/*
OpenApi2StarComponentCreateCommonComponentPost Method for OpenApi2StarComponentCreateCommonComponentPost

作为星图通用组件创建api提供出去

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApi2StarComponentCreateCommonComponentPostRequest
*/
func (a *StarComponentCreateCommonComponentV2ApiService) Post(ctx context.Context) *ApiOpenApi2StarComponentCreateCommonComponentPostRequest {
	return &ApiOpenApi2StarComponentCreateCommonComponentPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *StarComponentCreateCommonComponentV2ApiService) postExecute(r *ApiOpenApi2StarComponentCreateCommonComponentPostRequest) (*StarComponentCreateCommonComponentV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.starComponentCreateCommonComponentV2Request

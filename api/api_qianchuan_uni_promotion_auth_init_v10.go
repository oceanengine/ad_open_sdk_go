...
type QianchuanUniPromotionAuthInitV10ApiService service
...
func (r *ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest {
	if enable {
...
/*
OpenApiV10QianchuanUniPromotionAuthInitPost Method for OpenApiV10QianchuanUniPromotionAuthInitPost

授权初始化接口

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest
*/
func (a *QianchuanUniPromotionAuthInitV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest {
	return &ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanUniPromotionAuthInitV10ApiService) postExecute(r *ApiOpenApiV10QianchuanUniPromotionAuthInitPostRequest) (*QianchuanUniPromotionAuthInitV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanUniPromotionAuthInitV10Request

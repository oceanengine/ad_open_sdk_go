...
func (r *ApiOpenApiV10QianchuanFileVideoOriginalGetGetRequest) Execute() (*models.QianchuanFileVideoOriginalGetV10Response, *http.Response, error) {
...
func (a *QianchuanFileVideoOriginalGetV10ApiService) getExecute(r *ApiOpenApiV10QianchuanFileVideoOriginalGetGetRequest) (*models.QianchuanFileVideoOriginalGetV10Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.QianchuanFileVideoOriginalGetV10Response
	)

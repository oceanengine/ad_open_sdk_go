...
type ToolsAgreementCreateV30ApiService service
...
func (r *ApiOpenApiV30ToolsAgreementCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsAgreementCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsAgreementCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsAgreementCreatePostRequest {
	if enable {
...
/*
OpenApiV30ToolsAgreementCreatePost Method for OpenApiV30ToolsAgreementCreatePost

完成特定协议最新版本签署

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30ToolsAgreementCreatePostRequest
*/
func (a *ToolsAgreementCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsAgreementCreatePostRequest {
	return &ApiOpenApiV30ToolsAgreementCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsAgreementCreateV30ApiService) postExecute(r *ApiOpenApiV30ToolsAgreementCreatePostRequest) (*models.ToolsAgreementCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsAgreementCreateV30Request

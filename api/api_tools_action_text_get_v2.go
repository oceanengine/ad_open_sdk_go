...
type ApiOpenApi2ToolsActionTextGetGetRequest struct {
	...
	advancedCreativeType *interface{}
	advertiserId         *int64
	industry             *int64
	landingType          *string
}

func (r *ApiOpenApi2ToolsActionTextGetGetRequest) AdvancedCreativeType(advancedCreativeType interface{}) *ApiOpenApi2ToolsActionTextGetGetRequest {
...
func (r *ApiOpenApi2ToolsActionTextGetGetRequest) LandingType(landingType string) *ApiOpenApi2ToolsActionTextGetGetRequest {

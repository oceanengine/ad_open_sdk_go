...
func (r *ApiOpenApi2ToolsBidSuggestGetRequest) Geolocation(geolocation []*AudiencePackageCreateV2RequestGeolocationInner) *ApiOpenApi2ToolsBidSuggestGetRequest {

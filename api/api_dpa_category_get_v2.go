...
func (r *ApiOpenApi2DpaCategoryGetGetRequest) Execute() (*models.DpaCategoryGetV2Response, *http.Response, error) {
...
func (a *DpaCategoryGetV2ApiService) getExecute(r *ApiOpenApi2DpaCategoryGetGetRequest) (*models.DpaCategoryGetV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.DpaCategoryGetV2Response
	)

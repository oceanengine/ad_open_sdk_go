...
func (r *ApiOpenApi2ToolsRubeexGetGetRequest) PlatformName(platformName []string) *ApiOpenApi2ToolsRubeexGetGetRequest {
	r.platformName = &platformName
	return r
}

func (r *ApiOpenApi2ToolsRubeexGetGetRequest) ProjectStatus(projectStatus []string) *ApiOpenApi2ToolsRubeexGetGetRequest {

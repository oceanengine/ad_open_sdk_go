...
type QianchuanOverallLiveCreateV10ApiService service
...
func (r *ApiOpenApiV10QianchuanOverallLiveCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanOverallLiveCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanOverallLiveCreatePostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanOverallLiveCreatePostRequest {
	if enable {
...
/*
OpenApiV10QianchuanOverallLiveCreatePost Method for OpenApiV10QianchuanOverallLiveCreatePost

创建直播乘方计划

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV10QianchuanOverallLiveCreatePostRequest
*/
func (a *QianchuanOverallLiveCreateV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanOverallLiveCreatePostRequest {
	return &ApiOpenApiV10QianchuanOverallLiveCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanOverallLiveCreateV10ApiService) postExecute(r *ApiOpenApiV10QianchuanOverallLiveCreatePostRequest) (*QianchuanOverallLiveCreateV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanOverallLiveCreateV10Request

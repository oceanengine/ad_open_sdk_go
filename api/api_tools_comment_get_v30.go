...
type ApiOpenApiV30ToolsCommentGetGetRequest struct {
	...
	advertiserId    *int64
	platformVersion *ToolsCommentGetV30PlatformVersion
	startTime       *string
	endTime         *string
...
// 查询的平台版本，查询体验版需传入V2 允许值：V1 （默认值）， V2
func (r *ApiOpenApiV30ToolsCommentGetGetRequest) PlatformVersion(platformVersion ToolsCommentGetV30PlatformVersion) *ApiOpenApiV30ToolsCommentGetGetRequest {
...
// 是否包含计算指标，传入True则返回负评数和负评率 默认为True
func (r *ApiOpenApiV30ToolsCommentGetGetRequest) IncludeMetrics(includeMetrics bool) *ApiOpenApiV30ToolsCommentGetGetRequest {
...
func (a *ToolsCommentGetV30ApiService) getExecute(r *ApiOpenApiV30ToolsCommentGetGetRequest) (*ToolsCommentGetV30Response, *http.Response, error) {
	...
	if r.platformVersion == nil {
		return localVarReturnValue, nil, ReportError("platformVersion is required and must be specified")
	}
	if r.startTime == nil {
	...
	if r.includeMetrics != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include_metrics", r.includeMetrics)
	}
	if r.page != nil {

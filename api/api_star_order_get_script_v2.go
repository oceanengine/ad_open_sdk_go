...
func (r *ApiOpenApi2StarOrderGetScriptGetRequest) Execute() (*models.StarOrderGetScriptV2Response, *http.Response, error) {
...
func (a *StarOrderGetScriptV2ApiService) getExecute(r *ApiOpenApi2StarOrderGetScriptGetRequest) (*models.StarOrderGetScriptV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarOrderGetScriptV2Response
	)

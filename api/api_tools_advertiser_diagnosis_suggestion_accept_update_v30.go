...
type ToolsAdvertiserDiagnosisSuggestionAcceptUpdateV30ApiService service
...
func (r *ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest {
	if enable {
...
/*
OpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePost Method for OpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePost

采纳7R诊断建议

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest
*/
func (a *ToolsAdvertiserDiagnosisSuggestionAcceptUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest {
	return &ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsAdvertiserDiagnosisSuggestionAcceptUpdateV30ApiService) postExecute(r *ApiOpenApiV30ToolsAdvertiserDiagnosisSuggestionAcceptUpdatePostRequest) (*ToolsAdvertiserDiagnosisSuggestionAcceptUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsAdvertiserDiagnosisSuggestionAcceptUpdateV30Request

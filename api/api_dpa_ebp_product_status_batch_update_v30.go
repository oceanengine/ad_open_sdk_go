...
type DpaEbpProductStatusBatchUpdateV30ApiService service
...
func (r *ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest {
	if enable {
...
/*
OpenApiV30DpaEbpProductStatusBatchUpdatePost Method for OpenApiV30DpaEbpProductStatusBatchUpdatePost

EBP批量修改DPA商品状态

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest
*/
func (a *DpaEbpProductStatusBatchUpdateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest {
	return &ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DpaEbpProductStatusBatchUpdateV30ApiService) postExecute(r *ApiOpenApiV30DpaEbpProductStatusBatchUpdatePostRequest) (*DpaEbpProductStatusBatchUpdateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.dpaEbpProductStatusBatchUpdateV30Request

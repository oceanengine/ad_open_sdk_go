...
type QianchuanOverallVideoUpdateV10ApiService service
...
func (r *ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest {
	if enable {
...
/*
OpenApiV10QianchuanOverallVideoUpdatePost Method for OpenApiV10QianchuanOverallVideoUpdatePost

乘方商品投放计划编辑接口

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest
*/
func (a *QianchuanOverallVideoUpdateV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest {
	return &ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanOverallVideoUpdateV10ApiService) postExecute(r *ApiOpenApiV10QianchuanOverallVideoUpdatePostRequest) (*models.QianchuanOverallVideoUpdateV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanOverallVideoUpdateV10Request

...
func (r *ApiOpenApi2StarMcnGetContractedChallengeUrlGetRequest) Execute() (*models.StarMcnGetContractedChallengeUrlV2Response, *http.Response, error) {
...
func (a *StarMcnGetContractedChallengeUrlV2ApiService) getExecute(r *ApiOpenApi2StarMcnGetContractedChallengeUrlGetRequest) (*models.StarMcnGetContractedChallengeUrlV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarMcnGetContractedChallengeUrlV2Response
	)

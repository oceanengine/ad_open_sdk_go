...
type ToolsPrivativeWordBatchGetV30ApiService service
...
func (r *ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest {
	if enable {
...
*/
func (a *ToolsPrivativeWordBatchGetV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest {
	return &ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsPrivativeWordBatchGetV30ApiService) postExecute(r *ApiOpenApiV30ToolsPrivativeWordBatchGetPostRequest) (*ToolsPrivativeWordBatchGetV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsPrivativeWordBatchGetV30Request

...
type StarOrderFinishV2ApiService service
...
func (r *ApiOpenApi2StarOrderFinishPostRequest) AccessToken(accessToken string) *ApiOpenApi2StarOrderFinishPostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApi2StarOrderFinishPostRequest) WithLog(enable bool) *ApiOpenApi2StarOrderFinishPostRequest {
	if enable {
...
/*
OpenApi2StarOrderFinishPost Method for OpenApi2StarOrderFinishPost

任务验收

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApi2StarOrderFinishPostRequest
*/
func (a *StarOrderFinishV2ApiService) Post(ctx context.Context) *ApiOpenApi2StarOrderFinishPostRequest {
	return &ApiOpenApi2StarOrderFinishPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *StarOrderFinishV2ApiService) postExecute(r *ApiOpenApi2StarOrderFinishPostRequest) (*StarOrderFinishV2Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.starOrderFinishV2Request

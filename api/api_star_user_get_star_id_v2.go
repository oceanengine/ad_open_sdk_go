...
func (r *ApiOpenApi2StarUserGetStarIdGetRequest) Execute() (*models.StarUserGetStarIdV2Response, *http.Response, error) {
...
func (a *StarUserGetStarIdV2ApiService) getExecute(r *ApiOpenApi2StarUserGetStarIdGetRequest) (*models.StarUserGetStarIdV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.StarUserGetStarIdV2Response
	)

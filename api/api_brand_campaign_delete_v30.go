...
type BrandCampaignDeleteV30ApiService service
...
func (r *ApiOpenApiV30BrandCampaignDeletePostRequest) AccessToken(accessToken string) *ApiOpenApiV30BrandCampaignDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30BrandCampaignDeletePostRequest) WithLog(enable bool) *ApiOpenApiV30BrandCampaignDeletePostRequest {
	if enable {
...
/*
OpenApiV30BrandCampaignDeletePost Method for OpenApiV30BrandCampaignDeletePost

AD品牌广告组删除

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30BrandCampaignDeletePostRequest
*/
func (a *BrandCampaignDeleteV30ApiService) Post(ctx context.Context) *ApiOpenApiV30BrandCampaignDeletePostRequest {
	return &ApiOpenApiV30BrandCampaignDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *BrandCampaignDeleteV30ApiService) postExecute(r *ApiOpenApiV30BrandCampaignDeletePostRequest) (*BrandCampaignDeleteV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.brandCampaignDeleteV30Request

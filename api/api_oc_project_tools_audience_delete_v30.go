...
type OcProjectToolsAudienceDeleteV30ApiService service
...
func (r *ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest) AccessToken(accessToken string) *ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest) WithLog(enable bool) *ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest {
	if enable {
...
/*
OpenApiV30OcProjectToolsAudienceDeletePost Method for OpenApiV30OcProjectToolsAudienceDeletePost

删除定向调控任务

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest
*/
func (a *OcProjectToolsAudienceDeleteV30ApiService) Post(ctx context.Context) *ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest {
	return &ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *OcProjectToolsAudienceDeleteV30ApiService) postExecute(r *ApiOpenApiV30OcProjectToolsAudienceDeletePostRequest) (*OcProjectToolsAudienceDeleteV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.ocProjectToolsAudienceDeleteV30Request

...
func (r *ApiOpenApi2ToolsInterestActionId2wordGetRequest) TagType(tagType interface{}) *ApiOpenApi2ToolsInterestActionId2wordGetRequest {
	r.tagType = &tagType
	return r
}

func (r *ApiOpenApi2ToolsInterestActionId2wordGetRequest) TargetingType(targetingType interface{}) *ApiOpenApi2ToolsInterestActionId2wordGetRequest {

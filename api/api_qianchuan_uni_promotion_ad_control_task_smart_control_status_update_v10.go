...
type QianchuanUniPromotionAdControlTaskSmartControlStatusUpdateV10ApiService service
...
func (r *ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest {
	if enable {
...
/*
OpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePost Method for OpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePost

修改直播-一键控量计划调控状态

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest
*/
func (a *QianchuanUniPromotionAdControlTaskSmartControlStatusUpdateV10ApiService) Post(ctx context.Context) *ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest {
	return &ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *QianchuanUniPromotionAdControlTaskSmartControlStatusUpdateV10ApiService) postExecute(r *ApiOpenApiV10QianchuanUniPromotionAdControlTaskSmartControlStatusUpdatePostRequest) (*QianchuanUniPromotionAdControlTaskSmartControlStatusUpdateV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.qianchuanUniPromotionAdControlTaskSmartControlStatusUpdateV10Request

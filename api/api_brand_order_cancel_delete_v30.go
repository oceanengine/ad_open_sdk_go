...
type BrandOrderCancelDeleteV30ApiService service
...
func (r *ApiOpenApiV30BrandOrderCancelDeletePostRequest) AccessToken(accessToken string) *ApiOpenApiV30BrandOrderCancelDeletePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30BrandOrderCancelDeletePostRequest) WithLog(enable bool) *ApiOpenApiV30BrandOrderCancelDeletePostRequest {
	if enable {
...
/*
OpenApiV30BrandOrderCancelDeletePost Method for OpenApiV30BrandOrderCancelDeletePost

AD品牌2.0取消删除预订单

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30BrandOrderCancelDeletePostRequest
*/
func (a *BrandOrderCancelDeleteV30ApiService) Post(ctx context.Context) *ApiOpenApiV30BrandOrderCancelDeletePostRequest {
	return &ApiOpenApiV30BrandOrderCancelDeletePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *BrandOrderCancelDeleteV30ApiService) postExecute(r *ApiOpenApiV30BrandOrderCancelDeletePostRequest) (*BrandOrderCancelDeleteV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.brandOrderCancelDeleteV30Request

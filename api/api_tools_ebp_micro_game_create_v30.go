...
type ToolsEbpMicroGameCreateV30ApiService service
...
func (r *ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest {
	if enable {
...
/*
OpenApiV30ToolsEbpMicroGameCreatePost Method for OpenApiV30ToolsEbpMicroGameCreatePost

新增抖音小游戏

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest
*/
func (a *ToolsEbpMicroGameCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest {
	return &ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ToolsEbpMicroGameCreateV30ApiService) postExecute(r *ApiOpenApiV30ToolsEbpMicroGameCreatePostRequest) (*ToolsEbpMicroGameCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.toolsEbpMicroGameCreateV30Request

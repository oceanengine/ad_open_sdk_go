...
type DpaEbpProductCreateV30ApiService service
...
func (r *ApiOpenApiV30DpaEbpProductCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV30DpaEbpProductCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30DpaEbpProductCreatePostRequest) WithLog(enable bool) *ApiOpenApiV30DpaEbpProductCreatePostRequest {
	if enable {
...
/*
OpenApiV30DpaEbpProductCreatePost Method for OpenApiV30DpaEbpProductCreatePost

EBP新建通用版商品

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30DpaEbpProductCreatePostRequest
*/
func (a *DpaEbpProductCreateV30ApiService) Post(ctx context.Context) *ApiOpenApiV30DpaEbpProductCreatePostRequest {
	return &ApiOpenApiV30DpaEbpProductCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DpaEbpProductCreateV30ApiService) postExecute(r *ApiOpenApiV30DpaEbpProductCreatePostRequest) (*DpaEbpProductCreateV30Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.dpaEbpProductCreateV30Request

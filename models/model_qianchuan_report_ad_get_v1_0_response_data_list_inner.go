...
type QianchuanReportAdGetV10ResponseDataListInner struct {
	...
	//
	LiveOrderRefundCount7d *float64 `json:"live_order_refund_count_7d,omitempty"`
	//
	LiveOrderSettleAmount7d *float64 `json:"live_order_settle_amount_7d,omitempty"`
	//
	LiveOrderSettleCount7d *float64 `json:"live_order_settle_count_7d,omitempty"`
	//
	...
	//
	UpliftCreateOrderCount *float64 `json:"uplift_create_order_count,omitempty"`
	//
	UpliftCreateOrderGmv *float64 `json:"uplift_create_order_gmv,omitempty"`
	//
	UpliftCreateOrderRoi *float64 `json:"uplift_create_order_roi,omitempty"`
	//
	UpliftPayOrderCount *float64 `json:"uplift_pay_order_count,omitempty"`
	//
	UpliftPayOrderGmv *float64 `json:"uplift_pay_order_gmv,omitempty"`
	//
	UpliftPayOrderRoi *float64 `json:"uplift_pay_order_roi,omitempty"`
}

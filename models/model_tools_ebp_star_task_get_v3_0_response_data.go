...
// ToolsEbpStarTaskGetV30ResponseData
type ToolsEbpStarTaskGetV30ResponseData struct {
	// 任务内推广的Android应用包名
	...
	AudienceSettings   *ToolsEbpStarTaskGetV30ResponseDataAudienceSettings `json:"audience_settings,omitempty"`
	//
	...
	BriefType      *ToolsEbpStarTaskGetV30DataBriefType `json:"brief_type,omitempty"`
	// 一级行业分类ID
	...
	ProductAdditionalIntroduction *ToolsEbpStarTaskGetV30ResponseDataProductAdditionalIntroduction `json:"product_additional_introduction,omitempty"`
	...
	StarTaskAlbumMicroAppInfo *ToolsEbpStarTaskGetV30ResponseDataStarTaskAlbumMicroAppInfo `json:"star_task_album_micro_app_info,omitempty"`
	// 原生锚点ID
	StarTaskAnchorId   *int64                                               `json:"star_task_anchor_id,omitempty"`
	StarTaskAnchorType *ToolsEbpStarTaskGetV30DataStarTaskAnchorType        `json:"star_task_anchor_type,omitempty"`
	StarTaskAssetInfo  *ToolsEbpStarTaskGetV30ResponseDataStarTaskAssetInfo `json:"star_task_asset_info,omitempty"`
	// 任务审核拒绝原因和意见，没有则返回为空
	...
	StarTaskExternalAction     *ToolsEbpStarTaskGetV30DataStarTaskExternalAction `json:"star_task_external_action,omitempty"`
	// 星广联投任务ID
	StarTaskId *int64 `json:"star_task_id,omitempty"`
	// 任务内介绍文案
	StarTaskIntroductionText       *string                                                          `json:"star_task_introduction_text,omitempty"`
	StarTaskMaterialPurchaseMethod *ToolsEbpStarTaskGetV30DataStarTaskMaterialPurchaseMethod        `json:"star_task_material_purchase_method,omitempty"`
	StarTaskMaterialsRequirements  *ToolsEbpStarTaskGetV30ResponseDataStarTaskMaterialsRequirements `json:"star_task_materials_requirements,omitempty"`
	// 星广联投任务名称
	...
	StarTaskSource      *ToolsEbpStarTaskGetV30DataStarTaskSource `json:"star_task_source,omitempty"`
	// 任务开始时间，格式YYYY-MM-DD
	StarTaskStartTime *string                                      `json:"star_task_start_time,omitempty"`
	StarTaskStatus    *ToolsEbpStarTaskGetV30DataStarTaskStatus    `json:"star_task_status,omitempty"`
	StarTaskSubStatus *ToolsEbpStarTaskGetV30DataStarTaskSubStatus `json:"star_task_sub_status,omitempty"`
	// 任务标签
	...
	TaskContactInfo *ToolsEbpStarTaskGetV30ResponseDataTaskContactInfo `json:"task_contact_info,omitempty"`
	// 任务头图uri

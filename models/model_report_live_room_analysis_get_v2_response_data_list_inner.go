...
// ReportLiveRoomAnalysisGetV2ResponseDataListInner struct for ReportLiveRoomAnalysisGetV2ResponseDataListInner
type ReportLiveRoomAnalysisGetV2ResponseDataListInner struct {
	//
	...
	RoomStatus *ReportLiveRoomAnalysisGetV2DataListRoomStatus `json:"room_status,omitempty"`
	//

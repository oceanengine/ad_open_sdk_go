...
// ReportCreativeGetV2ResponseDataListInner struct for ReportCreativeGetV2ResponseDataListInner
type ReportCreativeGetV2ResponseDataListInner struct {
	Ac *ReportCreativeGetV2DataListAc `json:"ac,omitempty"`
	//
	...
	CampaignType *ReportCreativeGetV2DataListCampaignType `json:"campaign_type,omitempty"`
	//
	...
	CreativeMaterialMode *ReportCreativeGetV2DataListCreativeMaterialMode `json:"creative_material_mode,omitempty"`
	//
	...
	ExternalAction    *ReportCreativeGetV2DataListExternalAction `json:"external_action,omitempty"`
	//
	...
	Gender       *ReportCreativeGetV2DataListGender `json:"gender,omitempty"`
	//
	...
	ImageMode     *ReportCreativeGetV2DataListImageMode `json:"image_mode,omitempty"`
	//
	...
	Inventory   *ReportCreativeGetV2DataListInventory   `json:"inventory,omitempty"`
	LandingType *ReportCreativeGetV2DataListLandingType `json:"landing_type,omitempty"`
	//
	...
	Pricing           *ReportCreativeGetV2DataListPricing         `json:"pricing,omitempty"`
	PricingCategory   *ReportCreativeGetV2DataListPricingCategory `json:"pricing_category,omitempty"`
	//
	...
	RealRecallMatchType *ReportCreativeGetV2DataListRealRecallMatchType `json:"real_recall_match_type,omitempty"`
	//

...
// All allowed values of ReportAdGetV2DataListExternalAction enum
var AllowedReportAdGetV2DataListExternalActionEnumValues = []ReportAdGetV2DataListExternalAction{
...
// NewReportAdGetV2DataListExternalActionFromValue returns a pointer to a valid ReportAdGetV2DataListExternalAction
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewReportAdGetV2DataListExternalActionFromValue(v string) (*ReportAdGetV2DataListExternalAction, error) {
	ev := ReportAdGetV2DataListExternalAction(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ReportAdGetV2DataListExternalAction: valid values are %v", v, AllowedReportAdGetV2DataListExternalActionEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ReportAdGetV2DataListExternalAction) IsValid() bool {
	for _, existing := range AllowedReportAdGetV2DataListExternalActionEnumValues {
		if existing == v {
			return true
		}
	}

...
// NativeAnchorUpdateV30RequestAnchorInfoGameAnchorGamePackageListInner struct for NativeAnchorUpdateV30RequestAnchorInfoGameAnchorGamePackageListInner
type NativeAnchorUpdateV30RequestAnchorInfoGameAnchorGamePackageListInner struct {
	// 安卓礼包码，字符限制0～20
	AndroidPackageCode *string `json:"android_package_code,omitempty"`
	// 游戏礼包名称，字符限制0～14
	GamePackageName *string `json:"game_package_name,omitempty"`
	// 礼包内的礼品配置，数量限制0～8
	Gift []*NativeAnchorUpdateV30RequestAnchorInfoGameAnchorGamePackageListInnerGiftInner `json:"gift,omitempty"`

...
// StarDemandCreateAssignV2RequestDemandInfoAdSyncConfLocalPromotion 产出物推送本地推配置
type StarDemandCreateAssignV2RequestDemandInfoAdSyncConfLocalPromotion struct {

...
// All allowed values of ReportCampaignGetV2DataListExternalAction enum
var AllowedReportCampaignGetV2DataListExternalActionEnumValues = []ReportCampaignGetV2DataListExternalAction{
...
// NewReportCampaignGetV2DataListExternalActionFromValue returns a pointer to a valid ReportCampaignGetV2DataListExternalAction
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewReportCampaignGetV2DataListExternalActionFromValue(v string) (*ReportCampaignGetV2DataListExternalAction, error) {
	ev := ReportCampaignGetV2DataListExternalAction(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ReportCampaignGetV2DataListExternalAction: valid values are %v", v, AllowedReportCampaignGetV2DataListExternalActionEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ReportCampaignGetV2DataListExternalAction) IsValid() bool {
	for _, existing := range AllowedReportCampaignGetV2DataListExternalActionEnumValues {
		if existing == v {
			return true
		}
	}

...
const (
	...
	MATERIAL_STATUS_QUEUING_PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialOptStatus PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialOptStatus = "MATERIAL_STATUS_QUEUING"
)

...
// ReportAdvertiserGetV2ResponseDataListInner struct for ReportAdvertiserGetV2ResponseDataListInner
type ReportAdvertiserGetV2ResponseDataListInner struct {
	Ac *ReportAdvertiserGetV2DataListAc `json:"ac,omitempty"`
	//
	...
	CampaignType *ReportAdvertiserGetV2DataListCampaignType `json:"campaign_type,omitempty"`
	//
	...
	CreativeMaterialMode *ReportAdvertiserGetV2DataListCreativeMaterialMode `json:"creative_material_mode,omitempty"`
	//
	...
	ExternalAction    *ReportAdvertiserGetV2DataListExternalAction `json:"external_action,omitempty"`
	//
	...
	Gender       *ReportAdvertiserGetV2DataListGender `json:"gender,omitempty"`
	//
	...
	ImageMode     *ReportAdvertiserGetV2DataListImageMode `json:"image_mode,omitempty"`
	//
	...
	Inventory   *ReportAdvertiserGetV2DataListInventory   `json:"inventory,omitempty"`
	LandingType *ReportAdvertiserGetV2DataListLandingType `json:"landing_type,omitempty"`
	//
	...
	Pricing           *ReportAdvertiserGetV2DataListPricing         `json:"pricing,omitempty"`
	PricingCategory   *ReportAdvertiserGetV2DataListPricingCategory `json:"pricing_category,omitempty"`
	//
	...
	RealRecallMatchType *ReportAdvertiserGetV2DataListRealRecallMatchType `json:"real_recall_match_type,omitempty"`
	//

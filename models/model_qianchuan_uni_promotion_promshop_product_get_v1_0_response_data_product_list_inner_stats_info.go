...
// QianchuanUniPromotionPromshopProductGetV10ResponseDataProductListInnerStatsInfo 消耗指标
type QianchuanUniPromotionPromshopProductGetV10ResponseDataProductListInnerStatsInfo struct {
	//

...
// StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfQianchuan 产物推送千川配置
type StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfQianchuan struct {

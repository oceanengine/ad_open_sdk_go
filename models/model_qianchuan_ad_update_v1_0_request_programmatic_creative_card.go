...
// QianchuanAdUpdateV10RequestProgrammaticCreativeCard
type QianchuanAdUpdateV10RequestProgrammaticCreativeCard struct {
	//
	ComponentId *int64 `json:"component_id,omitempty"`
	//
	PromotionCardActionButton            *string                                                                           `json:"promotion_card_action_button,omitempty"`
	PromotionCardButtonSmartOptimization *QianchuanAdUpdateV10ProgrammaticCreativeCardPromotionCardButtonSmartOptimization `json:"promotion_card_button_smart_optimization,omitempty"`
	//

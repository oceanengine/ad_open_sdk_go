...
// QianchuanTodayLiveRoomGetV10ResponseDataRoomListInner struct for QianchuanTodayLiveRoomGetV10ResponseDataRoomListInner
type QianchuanTodayLiveRoomGetV10ResponseDataRoomListInner struct {
	//
	...
	RoomStatus *QianchuanTodayLiveRoomGetV10DataRoomListRoomStatus `json:"room_status,omitempty"`
	//

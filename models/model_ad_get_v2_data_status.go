...
// All allowed values of AdGetV2DataStatus enum
var AllowedAdGetV2DataStatusEnumValues = []AdGetV2DataStatus{
	"AD_STATUS_FROZEN",
	"AD_STATUS_REAUDIT",
	"AD_STATUS_DATA_ERROR",
	"AD_STATUS_DSP_AD_DISABLE",
	"AD_STATUS_AUDIT",
	"AD_STATUS_CREATE",
	"AD_STATUS_ADVERTISER_BUDGET_EXCEED",
	"AD_STATUS_PRE_ONLINE",
	"AD_STATUS_AUDIT_DENY",
	"AD_STATUS_CAMPAIGN_EXCEED",
	"AD_STATUS_BALANCE_EXCEED",
	"AD_STATUS_ADVERTISER_PRE_OFFLINE_BUDGET",
	"AD_STATUS_DONE",
	"AD_STATUS_NOT_START",
	"AD_STATUS_PRE_OFFLINE_BUDGET",
	"AD_STATUS_CAMPAIGN_PRE_OFFLINE_BUDGET",
	"AD_STATUS_DELIVERY_OK",
	"AD_STATUS_DELETE",
	"AD_STATUS_LIVE_CANNOT_LAUNCH",
	"AD_STATUS_AWEME_ACCOUNT_DISABLED",
	"AD_STATUS_AUDIT_STATUS_ERROR",
	"AD_STATUS_CAMPAIGN_DISABLE",
	"AD_STATUS_BUDGET_EXCEED",
	"AD_STATUS_SOME_DELIVERY_OK",
	"AD_STATUS_NO_SCHEDULE",
	"AD_STATUS_AWEME_ACCOUNT_PUNISHED",
	"AD_STATUS_CANNOT_EDIT",
	"AD_STATUS_DISABLE_BY_QUOTA",
	"AD_STATUS_EXTERNAL_URL_DISABLE",
	"AD_STATUS_LIVE_ROOM_OFF",
	"AD_STATUS_PRODUCT_OFFLINE",
	"AD_STATUS_DRAFT",
	"AD_STATUS_DISABLE",
}

// NewAdGetV2DataStatusFromValue returns a pointer to a valid AdGetV2DataStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewAdGetV2DataStatusFromValue(v string) (*AdGetV2DataStatus, error) {
	ev := AdGetV2DataStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for AdGetV2DataStatus: valid values are %v", v, AllowedAdGetV2DataStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v AdGetV2DataStatus) IsValid() bool {
	for _, existing := range AllowedAdGetV2DataStatusEnumValues {
		if existing == v {
			return true
		}
	}

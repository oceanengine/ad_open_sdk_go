...
// StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfContentMarketing 投放品牌广告（内容热推/内容服务）
type StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfContentMarketing struct {

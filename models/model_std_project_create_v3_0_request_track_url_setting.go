...
// StdProjectCreateV30RequestTrackUrlSetting
type StdProjectCreateV30RequestTrackUrlSetting struct {
	//
	ActionTrackUrl []string `json:"action_track_url,omitempty"`
	//
	ActiveTrackUrl []string                                    `json:"active_track_url,omitempty"`
	SendType       *StdProjectCreateV30TrackUrlSettingSendType `json:"send_type,omitempty"`
	//
	TrackUrl []string `json:"track_url,omitempty"`
	//
	TrackUrlGroupId *int64                                          `json:"track_url_group_id,omitempty"`
	TrackUrlType    *StdProjectCreateV30TrackUrlSettingTrackUrlType `json:"track_url_type,omitempty"`
	//

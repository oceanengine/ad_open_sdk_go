...
// ReportBrandAdGetV30ResponseDataDataReportsInnerDataReport
type ReportBrandAdGetV30ResponseDataDataReportsInnerDataReport struct {
	// 活动banner图点击数
	...
	// 推广页访问量
	ClickLandingAage *string `json:"click_landing_aage,omitempty"`
	// 主页商品橱窗访问量
	...
	// 粉丝视频播放数
	FansVideoPlayCount *string `json:"fansVideoPlayCount,omitempty"`
	// 粉丝视频评论数
	...
	// 直播间订单金额
	LubanLivePayOrderStatCost *string `json:"luban_live_pay_order_stat_cost,omitempty"`
	// 直播间15日订单金额
	...
	// A3人群新增数量
	YuntuA3Increase *string `json:"yuntu_a3_increase,omitempty"`
}

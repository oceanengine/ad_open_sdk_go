...
// EventManagerTrackUrlCreateV2RequestTrackUrlGroupsInner struct for EventManagerTrackUrlCreateV2RequestTrackUrlGroupsInner
type EventManagerTrackUrlCreateV2RequestTrackUrlGroupsInner struct {
	// 点击（监测链接），只允许传入1个

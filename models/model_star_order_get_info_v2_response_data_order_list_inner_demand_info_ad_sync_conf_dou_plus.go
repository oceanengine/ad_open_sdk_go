...
// StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfDouPlus 产出物推DOU+配置信息（仅需advertiser_id和dou_plus_uid）
type StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfDouPlus struct {

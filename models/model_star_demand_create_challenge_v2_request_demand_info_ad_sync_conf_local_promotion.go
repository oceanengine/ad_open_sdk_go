...
// StarDemandCreateChallengeV2RequestDemandInfoAdSyncConfLocalPromotion 本地推
type StarDemandCreateChallengeV2RequestDemandInfoAdSyncConfLocalPromotion struct {
	// 是否推送原素材 1-推送 2-不推送

...
// ReportAdGetV2ResponseDataListInner struct for ReportAdGetV2ResponseDataListInner
type ReportAdGetV2ResponseDataListInner struct {
	Ac *ReportAdGetV2DataListAc `json:"ac,omitempty"`
	//
	...
	CampaignType *ReportAdGetV2DataListCampaignType `json:"campaign_type,omitempty"`
	//
	...
	CreativeMaterialMode *ReportAdGetV2DataListCreativeMaterialMode `json:"creative_material_mode,omitempty"`
	//
	...
	ExternalAction    *ReportAdGetV2DataListExternalAction `json:"external_action,omitempty"`
	//
	...
	Gender       *ReportAdGetV2DataListGender `json:"gender,omitempty"`
	//
	...
	ImageMode     *ReportAdGetV2DataListImageMode `json:"image_mode,omitempty"`
	//
	...
	Inventory   *ReportAdGetV2DataListInventory   `json:"inventory,omitempty"`
	LandingType *ReportAdGetV2DataListLandingType `json:"landing_type,omitempty"`
	//
	...
	Pricing           *ReportAdGetV2DataListPricing         `json:"pricing,omitempty"`
	PricingCategory   *ReportAdGetV2DataListPricingCategory `json:"pricing_category,omitempty"`
	//
	...
	RealRecallMatchType *ReportAdGetV2DataListRealRecallMatchType `json:"real_recall_match_type,omitempty"`
	//

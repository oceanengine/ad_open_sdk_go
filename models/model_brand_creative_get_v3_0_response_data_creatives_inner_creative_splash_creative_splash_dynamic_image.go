...
type BrandCreativeGetV30ResponseDataCreativesInnerCreativeSplashCreativeSplashDynamicImage struct {
	...
	// 图片列表
	ImageInfoList []*BrandCreativeGetV30ResponseDataCreativesInnerCreativeSplashCreativeSplashDynamicImageImageInfoBkListInner `json:"image_info_list,omitempty"`
}

...
// StdProjectUpdateV30RequestTrackUrlSetting
type StdProjectUpdateV30RequestTrackUrlSetting struct {
	//
	ActionTrackUrl []string `json:"action_track_url,omitempty"`
	//
	ActiveTrackUrl []string                                    `json:"active_track_url,omitempty"`
	SendType       *StdProjectUpdateV30TrackUrlSettingSendType `json:"send_type,omitempty"`
	//
	TrackUrl []string `json:"track_url,omitempty"`
	//
	TrackUrlGroupId *int64                                          `json:"track_url_group_id,omitempty"`
	TrackUrlType    *StdProjectUpdateV30TrackUrlSettingTrackUrlType `json:"track_url_type,omitempty"`
	//

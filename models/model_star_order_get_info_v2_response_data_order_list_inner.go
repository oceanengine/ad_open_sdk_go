...
// StarOrderGetInfoV2ResponseDataOrderListInner struct for StarOrderGetInfoV2ResponseDataOrderListInner
type StarOrderGetInfoV2ResponseDataOrderListInner struct {
	...
	AuthorInfo         *StarOrderGetInfoV2ResponseDataOrderListInnerAuthorInfo `json:"author_info,omitempty"`
	// 组件点击检测链接

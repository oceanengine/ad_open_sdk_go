...
// StarDemandOmCreateChallengeV2RequestDemandInfoAdSyncConfOceanEngine 巨量引擎AD
type StarDemandOmCreateChallengeV2RequestDemandInfoAdSyncConfOceanEngine struct {
	// 是否推送原素材 1-推送 2-不推送

...
// StdProjectListV30ResponseDataListInnerTrackUrlSetting
type StdProjectListV30ResponseDataListInnerTrackUrlSetting struct {
	//
	ActionTrackUrl []string `json:"action_track_url,omitempty"`
	//
	ActiveTrackUrl []string                                          `json:"active_track_url,omitempty"`
	SendType       *StdProjectListV30DataListTrackUrlSettingSendType `json:"send_type,omitempty"`
	//
	TrackUrl []string `json:"track_url,omitempty"`
	//
	TrackUrlGroupId *int64                                                `json:"track_url_group_id,omitempty"`
	TrackUrlType    *StdProjectListV30DataListTrackUrlSettingTrackUrlType `json:"track_url_type,omitempty"`
	//

...
// ReportBrandCampaignGetV30ResponseDataDataReportsInnerDataReport
type ReportBrandCampaignGetV30ResponseDataDataReportsInnerDataReport struct {
	// 活动banner图点击数
	...
	// 直播间30日订单量
	LubanLivePayOrderCountByAuthor30Days *string `json:"luban_live_pay_order_count_by_author_30_days,omitempty"`
	// 直播间3日订单量

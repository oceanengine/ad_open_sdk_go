...
// DpaEbpClueProductListV30ResponseDataProductsInnerShopKeeperInfoTargetUrl
type DpaEbpClueProductListV30ResponseDataProductsInnerShopKeeperInfoTargetUrl struct {
	// 默认落地页

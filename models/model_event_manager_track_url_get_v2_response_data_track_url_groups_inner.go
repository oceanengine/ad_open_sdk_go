...
// EventManagerTrackUrlGetV2ResponseDataTrackUrlGroupsInner struct for EventManagerTrackUrlGetV2ResponseDataTrackUrlGroupsInner
type EventManagerTrackUrlGetV2ResponseDataTrackUrlGroupsInner struct {
	// 点击（监测链接）只允许传入1个

...
// QianchuanUniPromotionAdProductGetV10ResponseDataProductListInnerStatsInfo 消耗指标
type QianchuanUniPromotionAdProductGetV10ResponseDataProductListInnerStatsInfo struct {
	// 整体点击次数

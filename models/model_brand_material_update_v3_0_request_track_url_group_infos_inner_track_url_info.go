...
// BrandMaterialUpdateV30RequestTrackUrlGroupInfosInnerTrackUrlInfo
type BrandMaterialUpdateV30RequestTrackUrlGroupInfosInnerTrackUrlInfo struct {
	// 点击监测链接
	...
	TrackUrlSendType *BrandMaterialUpdateV30TrackUrlGroupInfosTrackUrlInfoTrackUrlSendType `json:"track_url_send_type,omitempty"`
}

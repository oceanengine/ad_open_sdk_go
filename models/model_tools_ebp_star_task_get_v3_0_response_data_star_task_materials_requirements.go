...
// ToolsEbpStarTaskGetV30ResponseDataStarTaskMaterialsRequirements 制作要求
type ToolsEbpStarTaskGetV30ResponseDataStarTaskMaterialsRequirements struct {
	// 补充说明，1-3000个字符
	...
	SpecifiedIsv    *ToolsEbpStarTaskGetV30DataStarTaskMaterialsRequirementsSpecifiedIsv `json:"specified_isv,omitempty"`
	//
	SpecifiedIsvDetail []*ToolsEbpStarTaskGetV30ResponseDataStarTaskMaterialsRequirementsSpecifiedIsvDetailInner `json:"specified_isv_detail,omitempty"`
	...
	VideoReviewer          *ToolsEbpStarTaskGetV30DataStarTaskMaterialsRequirementsVideoReviewer `json:"video_reviewer,omitempty"`
	//

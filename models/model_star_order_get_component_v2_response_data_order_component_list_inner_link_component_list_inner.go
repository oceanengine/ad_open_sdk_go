...
// StarOrderGetComponentV2ResponseDataOrderComponentListInnerLinkComponentListInner struct for StarOrderGetComponentV2ResponseDataOrderComponentListInnerLinkComponentListInner
type StarOrderGetComponentV2ResponseDataOrderComponentListInnerLinkComponentListInner struct {
	// 审核失败原因
	...
	//
	DownloadUrlHarmony *string `json:"download_url_harmony,omitempty"`
	// iOS app 下载链接
	DownloadUrlIos *string `json:"download_url_ios,omitempty"`
	// 安卓落地页链接
	LandingUrlAndroid *string `json:"landing_url_android,omitempty"`
	//
	LandingUrlHarmony *string `json:"landing_url_harmony,omitempty"`
	// iOS落地页链接

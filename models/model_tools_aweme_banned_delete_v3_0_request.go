...
// ToolsAwemeBannedDeleteV30Request struct for ToolsAwemeBannedDeleteV30Request
type ToolsAwemeBannedDeleteV30Request struct {
	// 广告主id
	...
	BannedType   ToolsAwemeBannedDeleteV30BannedType `json:"banned_type"`

...
// BrandMaterialListV30ResponseDataMaterialsInnerTrackUrlGroupInfosInnerTrackUrlInfo
type BrandMaterialListV30ResponseDataMaterialsInnerTrackUrlGroupInfosInnerTrackUrlInfo struct {
	// 点击监测链接
	...
	TrackUrlSendType *BrandMaterialListV30DataMaterialsTrackUrlGroupInfosTrackUrlInfoTrackUrlSendType `json:"track_url_send_type,omitempty"`
}

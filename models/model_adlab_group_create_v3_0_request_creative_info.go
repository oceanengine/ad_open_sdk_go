...
// AdlabGroupCreateV30RequestCreativeInfo 创意维度信息
type AdlabGroupCreateV30RequestCreativeInfo struct {
	...
	ImageMaterials []*AdlabGroupCreateV30RequestCreativeInfoImageMaterialsInner `json:"image_materials,omitempty"`
	// 创意分类-三级行业，填写三级行业ID
	...
	TitleMaterials []*AdlabGroupCreateV30RequestCreativeInfoTitleMaterialsInner `json:"title_materials"`
	// 视频素材 最多使用50个视频，当通投场景下只选择视频不选择图片时至少选择3个视频，如果视频和图片都选择则要保证一个横版视频+一个竖版视频+一张大图横图。非通投场景至少传入1张图片或1个视频
	VideoMaterials []*AdlabGroupCreateV30RequestCreativeInfoVideoMaterialsInner `json:"video_materials,omitempty"`
	// 应用下载详情页

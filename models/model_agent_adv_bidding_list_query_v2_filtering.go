...
// AgentAdvBiddingListQueryV2Filtering
type AgentAdvBiddingListQueryV2Filtering struct {
	AccountStatus *AgentAdvBiddingListQueryV2FilteringAccountStatus `json:"account_status,omitempty"`
	Active        *AgentAdvBiddingListQueryV2FilteringActive        `json:"active,omitempty"`

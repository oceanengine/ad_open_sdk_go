...
// StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfEcomShop 产出物同步抖店商家后台配置
type StarOrderGetInfoV2ResponseDataOrderListInnerDemandInfoAdSyncConfEcomShop struct {

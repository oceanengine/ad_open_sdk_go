...
// QianchuanReportAdMaterialGetV10ResponseDataMaterialInfoInnerMetrics 指标信息
type QianchuanReportAdMaterialGetV10ResponseDataMaterialInfoInnerMetrics struct {
	//
	...
	//
	QianchuanCommissionConvertCnt *float64 `json:"qianchuan_commission_convert_cnt,omitempty"`
	//
	QianchuanEffectiveViewConvertCount *float64 `json:"qianchuan_effective_view_convert_count,omitempty"`
	//
	QianchuanEffectiveViewConvertRate *float64 `json:"qianchuan_effective_view_convert_rate,omitempty"`
	//
	QianchuanEffectiveViewCpaPlatform *float64 `json:"qianchuan_effective_view_cpa_platform,omitempty"`
	//
	QianchuanEstimatedCommission *float64 `json:"qianchuan_estimated_commission,omitempty"`
	//
	QianchuanEstimatedCommissionRoi *float64 `json:"qianchuan_estimated_commission_roi,omitempty"`
	//

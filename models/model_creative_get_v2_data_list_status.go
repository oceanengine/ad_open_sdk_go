...
// All allowed values of CreativeGetV2DataListStatus enum
var AllowedCreativeGetV2DataListStatusEnumValues = []CreativeGetV2DataListStatus{
	"CREATIVE_STATUS_ADVERTISER_BUDGET_EXCEED",
	"CREATIVE_STATUS_ADVERTISER_PRE_OFFLINE_BUDGET",
	"CREATIVE_STATUS_AD_AUDIT",
	"CREATIVE_STATUS_AD_AUDIT_DENY",
	"CREATIVE_STATUS_AD_DISABLE",
	"CREATIVE_STATUS_AD_EXTERNAL_URL_DISABLE",
	"CREATIVE_STATUS_AD_PRE_OFFLINE_BUDGET",
	"CREATIVE_STATUS_AD_REAUDIT",
	"CREATIVE_STATUS_ALL",
	"CREATIVE_STATUS_AUDIT",
	"CREATIVE_STATUS_AUDIT_DENY",
	"CREATIVE_STATUS_AUTHORIZE_CANCEL",
	"CREATIVE_STATUS_AWEME_ACCOUNT_DISABLED",
	"CREATIVE_STATUS_AWEME_ANCHOR_DISABLED",
	"CREATIVE_STATUS_AWEME_ITEM_DISABLED",
	...
	"CREATIVE_STATUS_CAN_NOT_EDIT",
	"CREATIVE_STATUS_CAN_NOT_LAUNCH",
	"CREATIVE_STATUS_CREATE",
	"CREATIVE_STATUS_DATA_ERROR",
	"CREATIVE_STATUS_DELETE",
	"CREATIVE_STATUS_DELIVERY_OK",
	"CREATIVE_STATUS_DISABLE",
	"CREATIVE_STATUS_DONE",
	"CREATIVE_STATUS_FROZEN",
	"CREATIVE_STATUS_LIVE_ROOM_OFF",
	"CREATIVE_STATUS_NOT_START",
	"CREATIVE_STATUS_NO_DELIVERY",
	"CREATIVE_STATUS_NO_SCHEDULE",
	"CREATIVE_STATUS_PRODUCT_OFFLINE",
	"CREATIVE_STATUS_REAUDIT",
}

// NewCreativeGetV2DataListStatusFromValue returns a pointer to a valid CreativeGetV2DataListStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewCreativeGetV2DataListStatusFromValue(v string) (*CreativeGetV2DataListStatus, error) {
	ev := CreativeGetV2DataListStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for CreativeGetV2DataListStatus: valid values are %v", v, AllowedCreativeGetV2DataListStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v CreativeGetV2DataListStatus) IsValid() bool {
	for _, existing := range AllowedCreativeGetV2DataListStatusEnumValues {
		if existing == v {
			return true
		}
	}

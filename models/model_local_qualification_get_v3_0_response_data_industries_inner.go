...
// LocalQualificationGetV30ResponseDataIndustriesInner struct for LocalQualificationGetV30ResponseDataIndustriesInner
type LocalQualificationGetV30ResponseDataIndustriesInner struct {
	// 一级行业ID
	...
	// 开户资质列表，相关字段见下
	Others    []*LocalQualificationGetV30ResponseDataIndustriesInnerOthersInner `json:"others,omitempty"`
	Promotion *LocalQualificationGetV30ResponseDataIndustriesInnerPromotion     `json:"promotion,omitempty"`
}

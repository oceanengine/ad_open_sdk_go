...
type ApiOpenApiV10EnterpriseVideoInfoGetGetRequestExample struct {
	AdvertiserId  int64                                  `json:"advertiser_id,omitempty"`
	EndTime       *string                                `json:"end_time,omitempty"`
	Fields        []string                               `json:"fields,omitempty"`
	Filter        EnterpriseVideoInfoGetV10Filter        `json:"filter,omitempty"`
	LastEndTime   *string                                `json:"last_end_time,omitempty"`
	LastStartTime *string                                `json:"last_start_time,omitempty"`
	Limit         int64                                  `json:"limit,omitempty"`
	Offset        int64                                  `json:"offset,omitempty"`
	OrderField    string                                 `json:"order_field,omitempty"`
	OrderType     EnterpriseVideoInfoGetV10OrderType     `json:"order_type,omitempty"`
	RatioFields   []string                               `json:"ratio_fields,omitempty"`
	StartTime     *string                                `json:"start_time,omitempty"`
	TimeDimension EnterpriseVideoInfoGetV10TimeDimension `json:"time_dimension,omitempty"`
}
...
func main() {
	...
	var request ApiOpenApiV10EnterpriseVideoInfoGetGetRequestExample
	err := json.Unmarshal([]byte(demoreq), &request)
	if err != nil {
		log.Fatal(err)
	}

	resp, httpRes, err := apiClient.EnterpriseVideoInfoGetV10Api().
		Get(ctx).

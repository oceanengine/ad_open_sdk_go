...
type ApiOpenApiV10QianchuanReportUniPromotionDataGetGetRequestExample struct {
	AdvertiserId int64                                                `json:"advertiser_id"`
	DataTopic    QianchuanReportUniPromotionDataGetV10DataTopic       `json:"data_topic"`
	Dimensions   []string                                             `json:"dimensions"`
	Metrics      []string                                             `json:"metrics"`
	Filters      []*QianchuanReportUniPromotionDataGetV10FiltersInner `json:"filters"`
...
func main() {
	...
	var request ApiOpenApiV10QianchuanReportUniPromotionDataGetGetRequestExample
